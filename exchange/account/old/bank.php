                            ...
                            <form action="" method="post" id="submitpaymentform">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-12">
                                      ...
                                      <p>Kindly contact support to create bank account details for your transaction</p>
                                    </div>
                                        ...
                                        <div class="mt-3 mb-1 col-md-12">
                                            <input type="button" name="makedeposit" class="px-5 btn btn-primary btn-lg w-100"
