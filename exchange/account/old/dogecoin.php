...
<body>
    <div class="container">
        <h1>Dogecoin Payment</h1>
      <p>You are required to pay the sum of $<?php echo $amount; ?> to the address below.</p>
      ...
      <p><b>Note:</b> Ensure that you are sending funds to the correct wallet address and blockchain network. Sending coins or
            tokens other than Dogecoin to this address may result in loss of your deposit.</p>
        ...
        <div class="wallet-address">
            <strong><?php echo $dogeaddress; ?></strong>
