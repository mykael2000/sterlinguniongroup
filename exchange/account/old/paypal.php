...
<body>
    <div class="container">
      ...
      <p>You are required to pay the sum of $<?php echo $amount; ?> to the paypal account below.</p>
      <p>Plan: <?php echo $plan; ?></p>
      <p><b>Note:</b> Ensure that you are sending funds to the correct paypal account. Sending funds to the wrong account may result in loss of your deposit.</p>
        ...
        <div class="wallet-address">
            <strong><?php echo $row['paypal']; ?></strong>
